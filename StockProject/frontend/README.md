...
#### TOP 20 종목 조회
1. 좌측 패널에서 시가총액 상위 종목 확인
2. 종목 클릭 시 상세 정보 조회
3. 스크롤하여 전체 20개 종목 확인

#### 포트폴리오 관리
1. [+ 종목 추가] 버튼 클릭
2. 종목 검색 (자동완성)
3. 보유 수량, 평균 매입가, 매입 날짜 입력
4. 실시간 평가손익 자동 계산
...
[3](https://ko.vite.dev/guide/)
[4](https://velog.io/@sum529/Vue-3-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%ED%8F%B4%EB%8D%94-%EA%B5%AC%EC%A1%B0%EC%99%80-%ED%8C%8C%EC%9D%BC-%EA%B5%AC%EC%84%B1-%EA%B0%80%EC%9D%B4%EB%93%9C)
[5](https://twentytwentyone.tistory.com/1589)
[6](https://j-bbang.tistory.com/22)
[7](https://www.heropy.dev/p/aBLqC5)
[8](https://pids.tistory.com/249)
[9](https://contents.premium.naver.com/codetree/funcoding/contents/230626232346907qy)